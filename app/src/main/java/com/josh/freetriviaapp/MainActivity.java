...
import com.josh.freetriviaapp.data.AnswerListAsyncResponse;
import com.josh.freetriviaapp.data.QuestionBank;
import com.josh.freetriviaapp.model.Question;
import com.josh.freetriviaapp.model.Score;
import com.josh.freetriviaapp.util.Prefs;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        highestScoreTextView.setText(MessageFormat.format("High Score: {0}", String.valueOf(prefs.getHighScore())));
        questionList = new QuestionBank().getQuestions(new AnswerListAsyncResponse() {
            @Override
            public void processFinished(ArrayList<Question> questionArrayList) {

                //go through array list and get first question at index 0 and answer
